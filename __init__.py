...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    # Re-run whenever the target entity's state (including its friendly_name
    # attribute) changes — covers entity renames done via the HA UI.
    entry.async_on_unload(
        async_track_state_change_event(hass, [target_entity], update_entry_title)
    )
